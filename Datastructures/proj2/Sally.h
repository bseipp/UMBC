...
private:
	...
	//to be recorded during loops
	list<Token> operatorRecorder;
	list<Token> paramsRecorderList;
	...
	static void evaluateTkList(list<Token> tkList, Sally *Sptr);
	...
	static void doAssign(Sally *Sptr);

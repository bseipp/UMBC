...
L1_top:
	        ...
	        jne     L1_cont	   ; if not, jump to L1_cont and add the char
...
handle_ESC:
		...
		cmp     di, 55		; is it above 7?
	        ja     	lowercase ; if so, skip octal
		cmp	di, 48
		jb	lowercase
octalinit:
...
octalloop:
	        ...
	        mul     dh	 ; multiply the octal value by 8
